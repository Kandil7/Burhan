...
هذا الدليل يشرح بالتفصيل المطلق كل خطوة في نظام RAG الخاص بمشروع Athar، بدءاً من استلام سؤال المستخدم وحتى إرسال الإجابة النهائية.，我将详细解释每个组件、每个函数以及它们如何协同工作。
...
### 1.3 نظام RAG في Athar

يستخدم Athar نسخة محسنة من RAG تتضمن:
...
نظام Athar يستخدم تصنيفاً هجيناً يجمع بين طريقتين:
...
نظام Athar يجمع بين طريقتين للبحث:
