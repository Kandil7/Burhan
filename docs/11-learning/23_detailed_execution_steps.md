...
## شرح كل خطوة في نظام Athar من البداية للنهاية

هذا الدليل يشرح بالتفصيل كل خطوة في نظام Athar الإسلامية، بدءاً من استلام سؤال المستخدم وحتى إرسال الإجابة النهائية.，我将使用阿拉伯语撰写，确保使用正确的阿拉伯标点符号和完整的术语。
...
نظام Athar هو نظام سؤال وجواب إسلامي يستخدم تقنيات الذكاء الاصطناعي المتقدمة. يتكون النظام من خطوات متعددة تعمل معاً لتقديم إجابة دقيقة وموثقة للمستخدم.
