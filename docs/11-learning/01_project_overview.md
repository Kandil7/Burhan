# 🕌 دليل الترحيب بمشروع Burhan - الجزء الأول: نظرة عامة

## 1️⃣ ما هو مشروع Burhan؟

**Burhan** (أثر) هو **نظام إجابة على الأسئلة الإسلامية** (Islamic QA System) مبني على معمارية متعددة الوكلاء تسمى **Fanar-Sadiq**.
...
1. **Burhan هو نظام إجابة إسلامي** يستخدم معمارية متعددة الوكلاء
