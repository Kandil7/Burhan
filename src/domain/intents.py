...
class IntentLabel(str, Enum):
    """
    Granular intent labels for collection-specific classification.

    Used by CollectionAgents to classify queries into more specific
    sub-intents within each domain (e.g., FiqhHukm vs FiqhMasaail).
    """
