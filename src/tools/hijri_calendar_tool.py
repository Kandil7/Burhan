...
class IslamicMonth:
    ...
    SHAaban = {"en": "Sha'ban", "ar": "شعبان", "number": 8}
    RAMADAN = {"en": "Ramadan", "ar": "رمضان", "number": 9}
    SHAWWAL = {"en": "Shawwal", "ar": "شوال", "number": 10}
    DHU_AL_QAadah = {"en": "Dhu al-Qa'dah", "ar": "ذو القعدة", "number": 11}
...
SPECIAL_DATES = {
    ...
    (3, 12): {"name_en": "Mawlid al-Nabi (birth of Prophet Muhammad)", "name_ar": "المولد النبوي"},
        ...
        try:
            ...
            result = {
                ...
                "hijri_date": {
                    ...
                    "formatted_ar": f"{h_day} {month_info.get('ar', '')} {h_year} ه",
                },
            ...
            logger.info("hijri.converted", gregorian=g_date.isoformat(), hijri=f"{h_year}-{h_month:02d}-{h_day:02d}")
            ...
            return ToolOutput(result={}, success=False, error=f"Error converting dates: {str(e)}")
