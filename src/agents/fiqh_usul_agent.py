"""
Usul al-Fiqh (Principles of Jurisprudence) Agent for Athar Islamic QA system.

Explains methodology of deriving Islamic rulings.
Phase 4: Usul al-Fiqh retrieval pipeline.
"""
...
class FiqhUsulAgent(BaseAgent):
    """Usul al-Fiqh Retrieval Agent."""
    ...
    TEMPERATURE = 0.15
    MAX_TOKENS = 2048
    SYSTEM = "أنت متخصص في أصول الفقه ومنهجية الاستنباط.\nالمهم: اعرض من النصوص فقط مع المراجع [C1]، [C2]."
