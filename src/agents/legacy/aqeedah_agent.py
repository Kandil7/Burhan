...
This module provides the Aqeedah RAG agent that:
- Retrieves aqeedah passages from aqeedah_passages collection
- Applies aqeedah verification policies
- Generates answers with theological references

For new implementations, use CollectionAgent with YAML config from config/agents/aqeedah.yaml
"""
