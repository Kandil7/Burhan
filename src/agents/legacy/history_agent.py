...
This module provides the History RAG agent that:
- Retrieves Islamic history passages from history_passages collection
- Generates answers with historical context and timeline

For new implementations, use CollectionAgent with YAML config from config/agents/history.yaml
"""
