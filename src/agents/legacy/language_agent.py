...
This module provides the Language RAG agent that:
- Retrieves Arabic language passages from language_passages collection
- Generates answers with grammatical and rhetorical explanations

For new implementations, use CollectionAgent with YAML config from config/agents/language.yaml
"""
