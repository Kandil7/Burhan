"""
Islamic History Agent for Athar Islamic QA system.

Provides information about Islamic history, civilization, and historical figures.
Phase 4: History retrieval pipeline.
"""
...
class IslamicHistoryAgent(BaseAgent):
    """Islamic History Retrieval Agent."""
    name = "islamic_history_agent"
    COLLECTION = "islamic_history_passages"
    TOP_K_RETRIEVAL = 12
    TOP_K_RERANK = 5
    SCORE_THRESHOLD = 0.65
    TEMPERATURE = 0.2
    MAX_TOKENS = 2048
    SYSTEM = "أنت متخصص في التاريخ الإسلامي.\nالمهم: اعرض المعلومات من النصوص فقط مع المراجع [C1]، [C2]."
