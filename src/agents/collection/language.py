"""
Arabic Language Collection Agent.

Uses YAML config from config/agents/language.yaml
"""
...
class LanguageCollectionAgent(CollectionAgent):
    ...
    NO_PASSAGES_MESSAGE = "لم أجد معلومات لغوية كافية."
